# Compact View - 20026 FolderView3 Compatible
![preview1](preview.png)

Compact view that allows you to fit a larger number of Dockers in a single folder.

- Large Docker icons... this is what we love... icons!
- Changes include eliminating the status copy in the folder preview. Status can be easily recognized by the icon. 
